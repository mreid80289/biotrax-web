        ...
        <>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            <a
              ...
              <svg width="16" height="16" viewBox="0 0 814 1000" fill="#04201a"><path d="M788.1 340.9c-5.8 4.5-108.2 62.2-108.2 190.5 0 148.4 130.3 200.9 134.2 202.2-.6 3.2-20.7 71.9-68.7 141.9-42.8 61.6-87.5 123.1-155.5 123.1s-85.5-39.5-164-39.5c-76 0-103.7 40.8-165.9 40.8s-105-37.5-155.5-122.4c-58.7-101.8-106.7-278.7-106.7-448.3 0-244.3 155.5-373.5 308.5-373.5 81.5 0 149.5 42.8 200.5 42.8 48.5 0 124.8-45.4 217.5-45.4zm132.8-245.8c-5.1 6.1-14.4 11.1-23 10.5-1.1-8.7 3.2-18 8-23.7 5.1-6.1 14.8-10.9 22.5-11.2 1 9-2.6 17.9-7.5 24.4z"/></svg>
              Download
            </a>
          </div>
        </>
          ...
          <div style={{ display: 'flex', gap: 12, marginTop: 8, flexWrap: 'wrap' }}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8, alignItems: 'flex-start' }}>
              <a
                ...
                <svg width="22" height="22" viewBox="0 0 814 1000" fill="white"><path d="M788.1 340.9c-5.8 4.5-108.2 62.2-108.2 190.5 0 148.4 130.3 200.9 134.2 202.2-.6 3.2-20.7 71.9-68.7 141.9-42.8 61.6-87.5 123.1-155.5 123.1s-85.5-39.5-164-39.5c-76 0-103.7 40.8-165.9 40.8s-105-37.5-155.5-122.4c-58.7-101.8-106.7-278.7-106.7-448.3 0-244.3 155.5-373.5 308.5-373.5 81.5 0 149.5 42.8 200.5 42.8 48.5 0 124.8-45.4 217.5-45.4zm132.8-245.8c-5.1 6.1-14.4 11.1-23 10.5-1.1-8.7 3.2-18 8-23.7 5.1-6.1 14.8-10.9 22.5-11.2 1 9-2.6 17.9-7.5 24.4z"/></svg>
                <div>
